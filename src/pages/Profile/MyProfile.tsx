      ...
      <main className="w-full flex-1">
        <div className="mt-6 flex flex-col items-center relative">
          <img
            src={purpleShadow}
            alt=""
            className="absolute -top-120 scale-30"
          />
        ...
        <div className="flex gap-2 mt-8 w-full max-w-sm mx-auto">
          <button
            className={`flex-1 cursor-pointer flex items-center justify-center gap-2 font-bold py-2 rounded-lg transition duration-300 ${activeTab === "emBreve" ? "bg-purple-500 text-white" : "bg-gray-200"
              }`}
          ...
          <button
            className={`flex-1 flex cursor-pointer items-center justify-center gap-2 font-bold py-2 rounded-lg transition duration-300 ${activeTab === "passados" ? "bg-purple-500 text-white" : "bg-gray-200"
              }`}
